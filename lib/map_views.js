...
module.exports.OtpItineraryMapView = Backbone.View.extend({
    ...
    render : function() {
        ...
        for(var i=0; i < this.model.get('legs').length; i++) {
            ...
            if(leg.get('mode') == "WALK" || leg.get('mode') == "BICYCLE") {
                var popupContent = '<img src="../lib/images/mode/' + leg.get('mode').toLowerCase() + '.png"/> <img src="../lib/images/mode/arrow_right.png"/> ' + leg.get('to').name;
                ...
                var distance = utils.distanceString(leg.get('distance'));
                ...
                var popupContent = '<img src="../lib/images/mode/bus.png"/> ';
                ...
                popupContent += ' <img src="../lib/images/mode/arrow_right.png"/> ' + leg.get('to').name;
    ...
    getStepBubbleMarker : function(leg, step) {
        ...
        if(step.get('relativeDirection')) {
            ...
            var popupContent = '<span class="otp-legStepLabel-icon otp-legStep-icon-' + step.get('relativeDirection') + '"></span>' + ' <img src="../lib/images/mode/' + leg.get('mode').toLowerCase() + '.png"/> ' + step.get('streetName');

            popupContent += ' (';

            var distance = utils.distanceString(step.get('distance'));
    ...
    getLegFromBubbleMarker : function(leg, highlight) {
        ...
        var popupContent = '<img src="../lib/images/mode/arrow_right.png"/> <img src="../lib/images/mode/' + leg.get('mode').toLowerCase() + '.png"/> ';
        ...
        popupContent += ' ' + utils.formatTime(leg.get('startTime')) + ' ';
