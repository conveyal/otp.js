...
var PlanResponse = module.exports.OtpPlanResponse = Backbone.Model.extend({
  ...
  initialize: function(opts) {
    ...
    if (rawAttributes) {
      ...
      var processedAttributes = _.omit(rawAttributes, ['itineraries', 'to',
        'from'
      ]);
  ...
  initialize: function() {
    ...
    this.on('add', function(itin) {
      ...
      this.listenTo(itin, 'activate', function() {
        if (this.activeItinerary) this.activeItinerary.trigger(
          'deactivate');
...
var ItineraryWalkSteps = module.exports.OtpItineraryWalkSteps = Backbone.Collection
  .extend({
...
var StopsInRectangleRequest = module.exports.OtpStopsInRectangleRequest =
