...
},{"backbone":4,"jquery-browserify":6}],2:[function(require,module,exports){

require('./backbone');
require('./leaflet');
require('./otp');

},{"./backbone":1,"./leaflet":3,"./otp":8}],3:[function(require,module,exports){
...
},{"./src/models":9}],9:[function(require,module,exports){
...
module.exports.OtpPlanRequest = Backbone.Model.extend({ 
      ...
      request: function() {
        ...
        $.ajax(this.urlRoot + '/ws/plan', {dataType: 'jsonp', data: this.attributes})
          .done(function(data) {
            alert("done");
          })
          .fail(function(data){
...
module.exports.OtpItinerary = Backbone.Model.extend({ 
 ...
 module.exports.OtpItineraryLeg = Backbone.Model.extend({ 
  ...
  module.exports.OtpItineraryWalkSteps = Backbone.Model.extend({ 
...
},{"backbone":4,"jquery-browserify":6}]},{},[2])
;